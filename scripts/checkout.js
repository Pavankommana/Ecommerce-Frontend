import {cart, removeFromCart, saveLocalStorage, updateCartQuantity} from '../data/cart.js';
...
.forEach(deleteEle => {
    deleteEle.addEventListener('click', () => {
       const productId = deleteEle.dataset.productId;

        
       removeFromCart(productId);
       document.querySelector(`.js-container-${productId}`)
       .remove();
       checkoutQuantity();
